...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tool.parent'
        db.add_column(u'tools_tool', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(default=None, to=orm['tools.ToolClassification']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tool.parent'
        db.delete_column(u'tools_tool', 'parent_id')
