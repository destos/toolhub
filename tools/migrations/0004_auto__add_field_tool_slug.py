...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tools_tool', 'slug',
                      self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=255, separator=u'-', blank=True, default='', unique=True, populate_from='name', overwrite=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tool.slug'
        db.delete_column(u'tools_tool', 'slug')
